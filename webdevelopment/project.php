...
<html lang="en">
    ...
    <body>
        ...
        <h3>Flyers</h3>
            <div class="flyers">
                <img src="Mike Jones(1).jpg" alt="facebook ad" class="ad">
                <img src="Mike Jones(2).jpg" alt="cover photo kitchen" class="coverphoto">
                <img src="Mike Jones.jpg" alt="cover photo houses" class="coverphoto">
                <img src="DD 1.png" alt="direct door" class="directdoor">
            </div>
            <p>
        ...
        <h3>Cards</h3>
            <div class="cards">
                <img src="Front.jpg" alt="superhero card" class="bdaycard">
            </div>
            <p>
        ...
        <h3>Badges</h3>
            <div class="badges">
                <img src="Est. 2024.jpg" alt="badge" class="badge">
            </div>
            <p>
